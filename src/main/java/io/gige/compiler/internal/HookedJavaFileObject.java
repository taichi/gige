/**
 * ***************************************************************************** Copyright (c) 2006,
 * 2014 BEA Systems, Inc. and others All rights reserved. This program and the accompanying
 * materials are made available under the terms of the Eclipse Public License v1.0 which accompanies
 * this distribution, and is available at http://www.eclipse.org/legal/epl-v10.html
 *
 * <p>Contributors: wharley@bea.com - initial API and implementation
 *
 * <p>*****************************************************************************
 */
...
/**
 * A delegating JavaFileObject that hooks the close() methods of the Writer or OutputStream objects
 * that it produces, and notifies the annotation dispatch manager when a new compilation unit is
 * produced.
 */
public class HookedJavaFileObject extends ForwardingJavaFileObject<JavaFileObject> {
  ...
  /**
   * The name of the file that is created; this is passed to the CompilationUnit constructor, and
   * ultimately to the java.io.File constructor, so it is a normal pathname, just like what would be
